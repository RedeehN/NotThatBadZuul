...
//         veref.V.verifFinal( sFil, vMetName, vProtoM ); // inutile pour 0 param
        veref.V.vrai( veref.V.nbMet( sCla ) <= 1 ,
          "Si vous en êtes à l'étape 4, il y a au moins une méthode de trop ..." );
        veref.V.mesIfNot();        
...
//         veref.V.verifFinal( sFil, vMetName, vProtoM ); // inutile pour 0 param
        ...
        try { // tenir compte de l'ordre de déclaration des attributs !!! pour 2019/2020
            ...
            Room[] vTR = new Room[4];
            for ( vI=0; vI<4; vI++ )
                vTR[vI] = (Room)(sCon.newInstance( new Object[]{ "that's "+vTab[vI] } ));
            ...
            for ( vI=0; vI<4; vI++ ) {
                ...
                veref.V.vrai( vObj == vTR[vI],
                              " attribute "+vTab[vI]
                              +"  now contains  "+ vMet.invoke( vObj, new Object[]{} ) );
