...
public class CommandWords
{
    ...
    private static final String[] sValidCommands = {
        "go", "quit", "help","look", "eat", "back","test", "take", "drop","items","status"
    };
    ...
    {
        String vStringCommand = "";
        for (String vCommand : this.sValidCommands){
            vStringCommand += vCommand+" ";
        }
        return vStringCommand;
    }
